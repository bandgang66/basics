...
int main()
{
	...
	//Задание 2: Написать функцию, которая получает указатель на динамичесий массив и его размер. 
	...
	//dindelete(mass2, size2);		//очистка памяти под массив
	//	if (mass2 == nullptr)
	//	{
	//		cout << "динамический массив удален";
	//	}
	...
	//задание 3: Написать функцию, которая получает указатьель на статический массив и его размер,
